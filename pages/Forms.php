...
<head>
    ...
    .form p,
    .text div label,
    .text div p { /* Adjust the selector here */
        font-size: 25px; /* Set the desired font size for form type and description */
        color: green; /* Set the color to green */
...
<body>
    <div class="invoice">
        ...
        <div class="invoice-items">
            ...
            <div class="text">
                <p>
                    <span>Please call if you have any questions</span>
                </p>
            </div>
            <div>
